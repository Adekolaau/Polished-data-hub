...
FROM [olist].[dbo].[olist_order_payments_dataset]
...
SELECT pc.product_category_name_english AS category_name, op.payment_type, COUNT(*) AS payment_count

FROM [olist].[dbo].[olist_order_payments_dataset] AS op
...
ORDER BY category_name, payment_count DESC;

-- Analyze Payment Methods by Geographic Region:

SELECT c.customer_city AS city, op.payment_type, COUNT(*) AS payment_count
